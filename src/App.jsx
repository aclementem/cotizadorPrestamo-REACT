...
function App() {
  ...
  function handleClickDecremento() {
    ...
    if (valor < MIN) {
      Swal.fire("Cantidad no valida", "presiona OK para continuar", "error");
      return;
    }
  ...
  return (
    <div className="my-20 max-w-lg mx-auto bg-white shadow p-10">
      ...
      <input
        type="range"
        className="w-full bg-gray-200 accent-lime-500 hover:accent-lime-600 mt-3"
      ...
      <p className="text-center font-extrabold my-10 text-3xl text-indigo-500">
      ...
      <select
        className="mt-5 w-full p-2 bg-white border border-gray-500 rounded-lg text-center text-lg"
        value={meses}
